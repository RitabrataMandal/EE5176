...
%				\label{fig:problem1_linear}
			...
			\end{figure}
			\item Now taking the Figure \ref{fig:problem1_part2_cubic} converting to YCrCb and applying the median filter to the chrominance channels and then converting back it to RGB channel I get Figure~\ref{fig:problem_part2}
			\begin{figure}[H]
				\centering
				\resizebox{0.8\linewidth}{!}{
					\begin{tabular}{cc}
				...
				\resizebox{0.8\linewidth}{!}{
					\begin{tabular}{cc}
						...
						\begin{subfigure}[h]{0.45\linewidth}
							...
							\label{fig:RawImage2_denosing_2}
						\end{subfigure}\\
						\begin{subfigure}[h]{0.45\linewidth}
						\centering
						...
						\label{fig:RawImage3_denosing_2}
						\end{subfigure}
					\end{tabular}
				}
				\caption{Denoising}
